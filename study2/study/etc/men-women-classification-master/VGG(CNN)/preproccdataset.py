...
def create_rel_path():
    ...
    dirname_string = os.path.join('/home/funzin/study/men-women-classification-master/VGG(CNN)')
    dirname_path = os.path.normpath(dirname_string)
    path_for_train = os.path.join(dirname_path , "dataset","traindata","traindata")
    path_for_validation = os.path.join(dirname_path , 'dataset','crossvalidation')
...
def preprocess_forDir(path_to_save_in=r"C:/Users/evgen/Desktop/machine learning final project/dataset"):
    (path_for_train, path_for_validation, path_for_test) = create_rel_path()
